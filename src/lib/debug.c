...
#elif defined(HAV22E_SYS_PROCCTL_H) && defined(PROC_TRACE_CTL) \
	&& defined(PROC_TRACE_CTL_ENABLE) && defined(PROC_TRACE_CTL_DISABLE)
static int fr_set_dumpable_flag(bool dumpable)
{
...
#elif defined(HAVE_SYS_PROCCTL_H) && defined(PROC_TRACE_STATUS)
static int fr_get_dumpable_flag(void)
{
	int status;
